const mediaData = [
    { //1
      ...
      authorUrl: '',
      fileName: 'Above and Beyond',
      fileUrl: 'music/Above and Beyond.mp3',
      thumb: 'img/1.png' },
    
    { //2
      author: 'Silent Partner',
      authorUrl: '',
      fileName: 'Hit My Soul',
      fileUrl: 'music/Hit My Soul.mp3',
      thumb: 'img/2.png' },
    ...
    { //4
      ...
      fileUrl: 'music/Tidal Wave.mp3',
      thumb: 'img/4.png' },
    
    { //5
      author: 'Silent Partner',
      authorUrl: '',
      fileName: "Jack in the Box",
      fileUrl: 'music/Jack in the Box.mp3',
      thumb: 'img/5.png' },

    { //6
        author: 'Silent Partner',
        authorUrl: '',
        fileName: 'The Place Inside',
        fileUrl: 'music/The Place Inside.mp3',
        thumb: 'img/6.png' },
      
    { //7
        author: 'Silent Partner',
        authorUrl: '',
        fileName: 'The Bluest Star',
        fileUrl: 'music/The Bluest Star.mp3',
        thumb: 'img/7.png' },
      
    { //8
        author: 'Silent Partner',
        authorUrl: '',
        fileName: "Whistling Down the Road",
        fileUrl: 'music/Whistling Down the Road.mp3',
        thumb: 'img/8.png' },
    ...
    { //9
        ...
        authorUrl: '',
        fileName: "Jay Jay",
        fileUrl: 'music/Jay Jay.mp3',
        thumb: 'img/9.png' }
      
    /*{ //10
        author: 'Silent Partner',
        authorUrl: '',
        fileName: "Spring In My Step",
        fileUrl: 'music/Spring In My Step.mp3',
        thumb: 'https://static.dazedbear.pro/2018-ithome/41451305061_f0bd9717be_q.jpg' }*/
...
class AudioPlayer {
    ...
    // 取得當前音量
    getVolume() { return this.audioPlayer.volume; }
    
    // 取得當前秒數
    getCurrentTime() { return this.audioPlayer.currentTime; }
    
    // 取得當前歌曲總長度
    getDuration() { return this.audioPlayer.duration; }
...
$(document).ready(() => {
    // DOM elements
    const playBtn = $('#gogo'); // play_arrow, pause
    const prevBtn = $('#prev');
    const nextBtn = $('#next');
    ...
    // 監聽事件顯示 UI
    myAudio.on('playstatuschange', function(){
      if(myAudio.getIsPlaying())  playBtn.attr("src", "img/pause.gif");
      else playBtn.attr("src", "img/play.png");
    });
